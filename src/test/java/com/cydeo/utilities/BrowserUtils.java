...
public class BrowserUtils {
    ...
    // this method will execute Thread.sleep for given duration
    ...
    public static void switchWindowsAndVerify(String expectedURL, String expectedTitle) {
    ...
    public static void radioButton(List<WebElement> radioButtons, String attributeValue){
